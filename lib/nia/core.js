...
const NIA_LOGO_DATA_URI = 'data:image/png;base64,';
...
function buildSeedData() {
  const facilities = [
    ...
    },
    {
      ...
      facility_phone: '+254 720 334 510',
      county: 'Nairobi',
      active_status: true,
...
function niaRequireAuth() {
  ...
  if (user.role !== 'super_admin') {
    ...
    if (!db.facility) { niaLogout(); return null; }
...
function niaOwnerDashboard(db, user) {
  ...
  const card = (key, icon, title, question, metrics, tone, insight, action) => `<article class="owner-intelligence-card ${tone}"><div class="owner-card-heading"><div class="owner-card-icon">${niaIcon(icon)}</div><div><span class="eyebrow">${title}</span><h3>${question}</h3></div><span class="owner-status ${tone}">${statusLabel(tone)}</span></div><div class="owner-metrics">${metrics.map(metric => `<div><strong>${metric.value}</strong><span>${metric.label}</span></div>`).join('')}</div><div class="owner-insight-copy"><strong>${niaIcon(iconFor(tone))} ${insight}</strong><span>Suggested action: ${action}</span></div><button class="text-action" data-owner-action="${key}">${action} ${niaIcon('arrow')}</button></article>`;
    ...
    const plans = niaScopedPlans(scopedDb); const appointments = niaScopedAppointments(scopedDb); const followUps = niaScopedFollowUps(scopedDb); const procedures = niaScopedProcedures(scopedDb); const revenue = (selectedFacility.subscription?.payments || []).reduce((sum, payment) => sum + Number(payment.amount_usd || 0), 0);
    const patients = niaScopedPatients(scopedDb); const accepted = plans.filter(p => ['Accepted', 'In Progress', 'Completed'].includes(p.status));
    const treatmentAcceptance = pct(accepted.length, plans.filter(p => p.status !== 'Draft').length); const treatmentProgression = pct(plans.filter(p => p.status === 'Completed').length, accepted.length);
    const pendingValue = plans.filter(p => !['Completed', 'Rejected'].includes(p.status)).reduce((sum, p) => sum + Number(p.total_estimated_value || 0), 0);
    const overduePlans = plans.filter(p => p.status === 'Dropped Off').length; const followUpRate = pct(followUps.filter(f => f.outcome !== 'Not Reached').length, followUps.length);
    const completedAppointments = appointments.filter(a => ['Completed', 'Attended'].includes(a.status)).length; const appointmentRate = pct(completedAppointments, appointments.length);
    const noShows = appointments.filter(a => ['No-show', 'No Show'].includes(a.status)).length; const noShowRate = pct(noShows, appointments.length);
    const treatmentTone = statusFor(treatmentAcceptance, 75, 60); const followTone = statusFor(followUpRate, 90, 75); const recallTone = 'warning';
    const experienceTone = 'success'; const safetyTone = 'success';
    const healthTone = [treatmentTone, followTone, safetyTone].includes('danger') ? 'danger' : [treatmentTone, followTone].includes('warning') ? 'warning' : 'success';
    ...
    document.getElementById('content').innerHTML = `<div class="owner-hero"><div><div class="eyebrow">Practice intelligence dashboard</div><h1>Good morning, ${firstName}</h1><p>Decision support for ${db.facility.facility_name}, ${suffix}.</p></div><div class="owner-filters"><label>Branch<select id="owner-branch"><option>All Branches</option>${branchFacilities.filter(facility => facility.facility_id !== db.facility.facility_id).map(facility => `<option>${facility.facility_name.replace(/^NiaCARE\s*[—-]\s*/, '')}</option>`).join('')}</select></label><label>Period<select id="owner-period"><option>Week</option><option selected>Month</option><option>Quarter</option><option>Year</option></select></label></div></div>
      <section class="owner-health success"><div><span class="eyebrow">Overall practice health</span><div class="health-row"><span class="health-dot"></span><strong>Healthy, with attention needed</strong></div><p>Core operations are stable. Focus on treatment continuity and open safety actions.</p></div><div class="health-score"><strong>82</strong><span>/ 100</span><small>+6 vs last month</small></div></section>
      ...
      <div class="owner-kpi-grid"><article class="owner-kpi"><div class="owner-kpi-top"><span class="owner-kpi-icon">${niaIcon('reports')}</span><strong class="owner-kpi-change positive">+12.4% vs prior period</strong></div><strong class="owner-kpi-value">${money(revenue)}</strong><span>Revenue collected</span></article><article class="owner-kpi"><div class="owner-kpi-top"><span class="owner-kpi-icon">${niaIcon('patients')}</span><strong class="owner-kpi-change positive">+84 this month</strong></div><strong class="owner-kpi-value">${patients.length.toLocaleString()}</strong><span>Active patients</span></article><article class="owner-kpi"><div class="owner-kpi-top"><span class="owner-kpi-icon">${niaIcon('calendar')}</span><strong class="owner-kpi-change negative">-2.1% vs prior period</strong></div><strong class="owner-kpi-value">${appointmentRate}%</strong><span>Appointment completion</span></article><article class="owner-kpi"><div class="owner-kpi-top"><span class="owner-kpi-icon">${niaIcon('plans')}</span><strong class="owner-kpi-change positive">+4.8% vs prior period</strong></div><strong class="owner-kpi-value">${treatmentAcceptance}%</strong><span>Treatment acceptance</span></article></div>
      ...
      <section class="owner-next-steps"><div class="owner-next-steps-heading"><span class="eyebrow">Recommended next steps</span><h2>What needs your attention</h2></div><div class="owner-attention-grid"><article class="owner-attention-card treatment"><div class="owner-attention-icon">${niaIcon('bell')}</div><div><h3>Treatment drop-off needs attention</h3><p>7 patients have accepted plans with no appointment booked in the last 14 days.</p><button type="button" data-owner-action="treatment-plans">Review drop-off</button></div></article><article class="owner-attention-card safety"><div class="owner-attention-icon">${niaIcon('shield')}</div><div><h3>2 safety incidents remain open</h3><p>Both incidents are assigned and due for review this week.</p><button type="button" data-owner-action="incidents">View incidents</button></div></article><article class="owner-attention-card experience"><div class="owner-attention-icon">${niaIcon('check')}</div><div><h3>Patient experience is improving</h3><p>Feedback score is up 8% compared with the prior period.</p><button type="button" data-owner-action="feedback">View feedback</button></div></article></div></section>
      <div class="owner-section-head"><div><span class="eyebrow">Data → KPI → insight → action</span><h2>Five leadership signals</h2></div></div>
      <div class="owner-intelligence-grid">${card('treatment-plans', 'plans', 'Treatment performance', 'Are opportunities becoming care?', [{ value: plans.length, label: 'plans' }, { value: money(pendingValue), label: 'pending value' }, { value: `${treatmentAcceptance}%`, label: 'acceptance' }], treatmentTone, `${treatmentAcceptance}% treatment acceptance from ${plans.length} plans.`, treatmentTone === 'success' ? 'Maintain current presentation' : 'Review treatment follow-up')}${card('appointments', 'appointments', 'Patient follow-up & appointments', 'Are patients progressing to treatment?', [{ value: followUps.length, label: 'follow-ups' }, { value: `${followUpRate}%`, label: 'contact rate' }, { value: `${noShowRate}%`, label: 'no-show rate' }], followTone, `${followUpRate}% of follow-ups have a recorded outcome.`, followTone === 'success' ? 'Maintain current process' : 'Review follow-up barriers')}${card('recalls', 'calendar', 'Recall performance', 'Are existing patients returning?', [{ value: '—', label: 'due for recall' }, { value: '—', label: 'booking rate' }, { value: '—', label: 'completion' }], recallTone, 'Recall data is ready to be monitored as recall records are entered.', 'Review Recalls')}${card('feedback', 'heart', 'Patient experience', 'What are patients experiencing?', [{ value: '—', label: 'satisfaction' }, { value: '—', label: 'open complaints' }, { value: '—', label: 'resolution' }], experienceTone, 'Patient feedback signals are currently within target.', 'View Feedback')}${card('incidents', 'shield', 'Patient safety', 'Are safety issues requiring attention?', [{ value: '0', label: 'serious incidents' }, { value: '0', label: 'open incidents' }, { value: '0%', label: 'closure rate' }], safetyTone, 'No serious patient safety incidents recorded.', 'View Incidents')}</div>
      <section class="card owner-trace"><div><span class="eyebrow">Traceability</span><h3>Underlying practice data</h3><p>${patients.length} patients · ${appointments.length} appointments · ${procedures.length} procedures. Every signal links back to operational records.</p></div><button class="btn btn-primary btn-sm" data-owner-action="reports">View records ${niaIcon('arrow')}</button></section>`;
    ...
    document.querySelectorAll('[data-owner-action]').forEach(button => button.onclick = () => { const page = button.dataset.ownerAction; if (page === 'reports') window.location.hash = '#reports'; else { window.location.hash = `#${page}`; bindNavLinks(); } });
    bindNavLinks();
  };
  render();
}
...
Pages.facility = function (db, user) {
  ...
  <div class="card">
  <div class="facility-profile-header"><div class="facility-profile-heading"><div class="facility-profile-icon">⌂</div><div><div class="eyebrow">Facility profile</div><h3 id="facility-profile-title">${(profileFacility.facility_name || 'Facility').replace(/^NiaCARE\s*[—-]\s*/, '')}</h3><span class="form-hint" id="facility-profile-context">Main facility</span></div></div><button class="btn btn-ghost btn-sm" id="edit-facility">Edit Facility Details</button></div>
  <div class="card-pad" id="facility-profile-body">
  <div class="facility-profile-details">
    <div class="facility-detail-row"><span>Facility Name</span><strong>${profileFacility.facility_name || '—'}</strong></div>
    <div class="facility-detail-row"><span>Facility Code</span><strong>${profileFacility.facility_code || '—'}</strong></div>
    <div class="facility-detail-row"><span>Email</span><strong>${profileFacility.facility_email || '—'}</strong></div>
    <div class="facility-detail-row"><span>Phone</span><strong>${profileFacility.facility_phone || '—'}</strong></div>
    <div class="facility-detail-row"><span>County</span><strong>${profileFacility.county || '—'}</strong></div>
    <div class="facility-detail-row"><span>Status</span><strong><span class="badge ${profileFacility.active_status ? 'badge-success' : ''}">${profileFacility.active_status ? 'Active' : 'Inactive'}</span></strong></div>
    <div class="facility-detail-divider"></div>
    <div class="facility-metric-grid"><div><span>Total Users</span><strong>${niaScopedUsers(profileDb()).length}</strong></div><div><span>Total Patients</span><strong>${niaScopedPatients(profileDb()).length}</strong></div><div><span>Created</span><strong>${fmtDate(profileFacility.created_at)}</strong></div></div>
  </div>
  </div>
  </div>
      ...
      <div class="card mt-16">
        ...
        <div class="card-pad">
          <div class="form-grid">
            <div class="form-field"><label>Branch name</label><input type="text" id="branch-name" placeholder="e.g. Bamburi Dental Centre" /></div>
            <div class="form-field"><label>County</label><input type="text" id="branch-county" value="${f.county || ''}" /></div>
            <div class="form-field"><label>Email</label><input type="email" id="branch-email" placeholder="branch@example.com" /></div>
            <div class="form-field"><label>Phone</label><input type="text" id="branch-phone" placeholder="+254 ..." /></div>
          </div>
          <button class="btn btn-primary mt-24" id="add-branch">Add Branch</button>
          <div class="mt-16" id="branch-list">${(db.facilities || []).filter(branch => branch.parent_facility_id === f.facility_id && branch.active_status).map(branch => `<div class="flex-between" style="padding:10px 0; border-top:1px solid var(--nia-border);"><span><strong>${branch.facility_name.replace(/^NiaCARE\s*[—-]\s*/, '')}</strong><small style="display:block; color:var(--nia-ink-soft);">${branch.county || 'County not set'} · ${branch.facility_code}</small></span><span style="display:flex; align-items:center; gap:8px;"><span class="badge badge-success">Active</span><button class="btn btn-ghost btn-sm view-facility" data-facility="${branch.facility_id}">View Facility</button></span></div>`).join('') || '<div class="form-hint">No additional branches yet.</div>'}</div>
        </div>
      </div>
