...
Pages.facility = function (db, user) {
  ...
  const html = `
    <div style="display:grid; grid-template-columns:1fr 320px; gap:18px;">
      <div class="card">
        <div class="card-header"><h3 id="facility-profile-title">Facility Profile</h3><span class="form-hint" id="facility-profile-context">Main facility</span></div>
        <div class="card-pad">
          <div class="form-grid">
            <div class="form-field"><label>Facility Name</label><input type="text" id="f-name" value="${profileFacility.facility_name}" /></div>
            <div class="form-field"><label>Facility Code</label><input type="text" id="f-code" value="${profileFacility.facility_code}" readonly /></div>
            <div class="form-field"><label>Email</label><input type="email" id="f-email" value="${profileFacility.facility_email}" /></div>
            <div class="form-field"><label>Phone</label><input type="text" id="f-phone" value="${profileFacility.facility_phone}" /></div>
            <div class="form-field"><label>County</label><input type="text" id="f-county" value="${profileFacility.county}" /></div>
            <div class="form-field"><label>Status</label><select id="f-status"><option ${profileFacility.active_status ? 'selected' : ''}>Active</option><option ${!profileFacility.active_status ? 'selected' : ''}>Inactive</option></select></div>
          </div>
  ...
  document.querySelectorAll('.view-facility').forEach(button => button.addEventListener('click', () => {
    ...
    document.getElementById('facility-profile-title').textContent = 'Facility Profile';
    document.getElementById('facility-profile-context').textContent = `Viewing ${profileFacility.facility_name.replace(/^NiaCARE\s*[—-]\s*/, '')}`;
    document.getElementById('f-name').value = profileFacility.facility_name || '';
    document.getElementById('f-code').value = profileFacility.facility_code || '';
    document.getElementById('f-email').value = profileFacility.facility_email || '';
    document.getElementById('f-phone').value = profileFacility.facility_phone || '';
    document.getElementById('f-county').value = profileFacility.county || '';
    document.getElementById('f-status').value = profileFacility.active_status ? 'Active' : 'Inactive';
  }));
