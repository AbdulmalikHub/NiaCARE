...
Pages.facility = function (db, user) {
  ...
  <div class="card">
  <div class="card-header"><div><h3 id="facility-profile-title">Facility Profile</h3><span class="form-hint" id="facility-profile-context">Main facility</span></div><button class="btn btn-ghost btn-sm" id="edit-facility">Edit Facility Details</button></div>
  <div class="card-pad" id="facility-profile-body">
  <div class="facility-profile-details">
    <div class="facility-detail-row"><span>Facility ID</span><strong id="profile-facility-id">${profileFacility.facility_id}</strong></div>
    <div class="facility-detail-row"><span>Total Users</span><strong id="profile-total-users">${niaScopedUsers(profileDb()).length}</strong></div>
    <div class="facility-detail-row"><span>Created</span><strong id="profile-created">${fmtDate(profileFacility.created_at)}</strong></div>
    <div class="facility-detail-row"><span>Total Patients</span><strong id="profile-total-patients">${niaScopedPatients(profileDb()).length}</strong></div>
  </div>
  </div>
  </div>
